...
#BUTTONS 
def Content_Rating():  
    messagebox.showinfo("Netflix", "Content Ratings clicked \nPlease Wait for the Rating to appear...")  
    ...
    pieChart = px.pie(z, values='counts', names='rating', 
                      title='Content Ratings on Netflix',labels='Netflix', 
                      color_discrete_sequence=px.colors.qualitative.Set3)
    pieChart.show()

def Trend():  
    messagebox.showinfo("Netflix", "Trend button clicked \nPlease wait for the result to be displayed.")  
...
def Top_Directors():  
    messagebox.showinfo("NEtflix", "Top 5 Directors clicked \nPlease wait for the result to be displayed.")  
    #Top 5 Directors
...
def Sentiment():  
    messagebox.showinfo("Netflix", "Sentiment Analysis Clicked \nPlease wait for the result to be displayed.")    
    #Sentiment Analysis
